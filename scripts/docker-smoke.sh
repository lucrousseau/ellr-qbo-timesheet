...
DEV_SEED_TENANT_ADMIN_EMAIL="$(read_env_value DEV_SEED_TENANT_ADMIN_EMAIL)"
DEV_SEED_TENANT_ADMIN_PASSWORD="$(read_env_value DEV_SEED_TENANT_ADMIN_PASSWORD)"
...
SMOKE_LOGIN_EMAIL="${SMOKE_LOGIN_EMAIL:-${DEV_SEED_TENANT_ADMIN_EMAIL:-admin@ellr.local}}"
SMOKE_LOGIN_PASSWORD="${SMOKE_LOGIN_PASSWORD:-${DEV_SEED_TENANT_ADMIN_PASSWORD:-EllrDev!2026}}"
COOKIE_JAR="$(mktemp)"
