...
return [
    ...
    'expense_not_editable' => 'Seules les dépenses en attente peuvent être modifiées.',
    'expense_not_deletable' => 'Seules les dépenses en attente ou refusées peuvent être supprimées.',
    'expense_review_forbidden' => 'Vous n\'êtes pas autorisé à réviser cette dépense.',
    'expense_self_review_forbidden' => 'Vous ne pouvez pas réviser vos propres dépenses.',
    'expense_invalid_payment_account' => 'Le compte de paiement sélectionné n\'est pas disponible dans QuickBooks.',
    'expense_invalid_expense_account' => 'Le compte de dépense sélectionné n\'est pas disponible dans QuickBooks.',
    'expense_invalid_vendor' => 'Le fournisseur sélectionné n\'est pas disponible dans QuickBooks.',
