...
export const frMessages: Messages = {
  ...
  admin: {
    ...
    timeApprovalsHelp:
      'Révisez les entrées de temps des employés avant leur synchronisation vers QuickBooks. Vous pouvez modifier les entrées en attente, puis les approuver ou les refuser. Une fois approuvées, les entrées ne sont plus modifiables dans Ellr. Les entrées refusées restent uniquement dans Ellr.',
