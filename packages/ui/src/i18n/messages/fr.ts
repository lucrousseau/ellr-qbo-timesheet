...
export const frMessages: Messages = {
  ...
  expense: {
    ...
    help: 'Soumettez une dépense pour approbation. Les dépenses approuvées sont synchronisées vers QuickBooks en tant qu\'achats (Purchase).',
    amount: 'Montant',
    txnDate: 'Date',
    paymentType: 'Mode de paiement',
    paymentTypeCash: 'Espèces',
    paymentTypeCheck: 'Chèque',
    paymentTypeCreditCard: 'Carte de crédit',
    ...
    description: 'Description',
    billable: 'Facturable',
    choosePaymentAccount: 'Choisir un compte de paiement',
    chooseExpenseAccount: 'Choisir un compte de dépense',
    chooseVendor: 'Choisir un fournisseur (facultatif)',
    chooseCustomer: 'Choisir un client (facultatif)',
    chooseProject: 'Choisir un projet (facultatif)',
    searchPaymentAccounts: 'Rechercher des comptes de paiement',
    searchExpenseAccounts: 'Rechercher des comptes de dépense',
    searchVendors: 'Rechercher des fournisseurs',
    searchCustomers: 'Rechercher des clients',
    searchProjects: 'Rechercher des projets',
    loadingPaymentAccounts: 'Chargement des comptes de paiement…',
    loadingExpenseAccounts: 'Chargement des comptes de dépense…',
    loadingVendors: 'Chargement des fournisseurs…',
    loadingCustomers: 'Chargement des clients…',
    loadingProjects: 'Chargement des projets…',
    noPaymentAccounts: 'Aucun compte de paiement disponible.',
    noExpenseAccounts: 'Aucun compte de dépense disponible.',
    noVendors: 'Aucun fournisseur disponible.',
    noCustomers: 'Aucun client disponible.',
    noProjects: 'Aucun projet pour ce client.',
    noPaymentAccountResults: 'Aucun compte de paiement correspondant.',
    noExpenseAccountResults: 'Aucun compte de dépense correspondant.',
    noVendorResults: 'Aucun fournisseur correspondant.',
    noCustomerResults: 'Aucun client correspondant.',
    noProjectResults: 'Aucun projet correspondant.',
    selectCustomerFirst: 'Sélectionnez d\'abord un client.',
    loadPaymentAccountsFailed: 'Impossible de charger les comptes de paiement.',
    loadExpenseAccountsFailed: 'Impossible de charger les comptes de dépense.',
    loadVendorsFailed: 'Impossible de charger les fournisseurs.',
    loadCustomersFailed: 'Impossible de charger les clients.',
    loadProjectsFailed: 'Impossible de charger les projets.',
    submit: 'Soumettre la dépense',
    submitting: 'Soumission…',
    created: 'Dépense soumise pour approbation.',
    createFailed: 'Impossible de soumettre la dépense.',
    loadFailed: 'Impossible de charger les dépenses.',
    listTitle: 'Vos dépenses',
    empty: 'Aucune dépense pour le moment.',
    statusPending: 'En attente d\'approbation',
    statusApproved: 'Approuvée',
    statusRejected: 'Refusée',
    approvalsTitle: 'Approbations de dépenses en attente',
    approvalsHelp:
      'Révisez les dépenses des employés avant leur synchronisation vers QuickBooks en tant qu\'achats. Les dépenses refusées restent uniquement dans Ellr.',
    noPendingApprovals: 'Aucune dépense en attente à réviser.',
    approveSuccess: 'Dépense approuvée et envoyée à QuickBooks.',
    approveSuccessQueued: 'Dépense approuvée. Synchronisation QuickBooks en cours.',
    rejectSuccess: 'Dépense refusée.',
    approveFailed: 'Impossible de réviser la dépense.',
    delete: 'Supprimer',
